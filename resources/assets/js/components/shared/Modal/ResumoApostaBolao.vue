<template>
  <div id="modal-regular" class="modal summary modal-analitico" tabindex="-1">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h3 class="modal-title"><strong>Resumo da simulação</strong></h3>
        </div>
        <div class="modal-body" v-if="aposta !== null">
          <div class="block full bordered">
            ...
            <div class="row text-light p-lr p-tb">
              ...
              <div class="col-md-6 form-inline">
                <h4>Bolão:
                  <span class="text-muted">{{ aposta.bolao.nome }}</span>
                </h4>
                <h4>Data:
                  <span class="text-muted">{{ formatarData(aposta.created_at) }}</span>
                </h4>
                <h4>Valor:
        ...
        <div class="modal-footer">
          <button @click.prevent="hideModal" type="button" class="btn btn-danger">
