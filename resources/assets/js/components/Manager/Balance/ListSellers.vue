<template>
  <div class="block full bordered">
    ...
    <div class="btn-group btn-group-full p-lr p-tb">
      ...
      <button @click.prevent="resetAll(false)" class="btn btn-success p-lr">
        <i class="fa fa-repeat"></i> Resetar
      </button>
      <button @click.prevent="zeroToAll" class="btn btn-danger p-lr">
        <i class="fa fa-times"></i> Zerar
      </button>
      <button @click.prevent="resetAll(true)" class="btn btn-primary p-lr">
...
<script>
  export default {
    ...
    methods: {
      getSellers() {
        this.$http.get('/manager/balance/sellers')
      ...
      saveSeller(seller) {
        ...
        this.$http.post('/manager/balance/send', {seller})
          .then(response => {
      ...
      resetBalance(seller) {
        this.$http.post('/manager/balance/reset', {seller})
          .then(response => {
            let responseSeller = response.body.seller
      ...
      resetAll(force = false) {
        this.$swal({
          ...
          this.$http.post('/manager/balance/reset-all', {force: force})
            .then(response => {
      ...
      zeroToAll() {
        this.$swal({
          ...
          this.$http.post('/manager/balance/zero-all')
            .then(() => {
              this.isLoading = false
