...
<script>
  export default {
    ...
    methods: {
      getSellers() {
        this.$http.get('/supervisor/balance/sellers')
      ...
      saveSeller(seller) {
        ...
        this.$http.post('/supervisor/balance/send', {seller})
          .then(response => {
      ...
      resetBalance(seller) {
        this.$http.post('/supervisor/balance/reset', {seller})
          .then(response => {
            let responseSeller = response.body.seller
      ...
      resetAll(force = false) {
        this.$swal({
          ...
          this.$http.post('/supervisor/balance/reset-all', {force: force})
            .then(response => {
      ...
      zeroToAll() {
        this.$swal({
          ...
          this.$http.post('/supervisor/balance/zero-all')
            .then(() => {
              this.isLoading = false
