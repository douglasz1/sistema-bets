...
@section('content')
    <div class="block full bordered">
        ...
        <div class="btn-group btn-group-full btn-group-space p-lr p-tb">
            <a class="btn btn-primary" href="{{ route('admin.bolao.detalhes', ['id' => $bolao->id]) }}">
                Detalhes
            </a>
            <a class="btn btn-info" href="{{ route('admin.bolao.apostas', ['id' => $bolao->id]) }}">
                Apostas
            </a>
            <a class="btn btn-success" href="{{ route('admin.bolao.vencedor', ['id' => $bolao->id]) }}">
                Calcular vencedor
            </a>
        </div>
        <div class="block-title">
        ...
        {!! Form::model($bolao, ['route' => ['admin.bolao.placares.salvar', 'id' => $bolao->id]]) !!}
