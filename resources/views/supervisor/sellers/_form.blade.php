<div class="block full bordered">
    <div class="block-title">
        <h2>Dados operador</h2>
    </div>
    <div class="block-content form-horizontal form-bordered p-b p-lr">
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group{{ $errors->has('user_id') ? ' has-error' : '' }}">
                    {!! Form::select('user_id', $managers, null, ['class' => 'form-control select-chosen']) !!}
                    @if ($errors->has('user_id'))
                        <div class="help-block animation-slideUp">{{ $errors->first('user_id') }}</div>
                    @endif
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-6">
                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                    <div class="input-group">
                        ...
                        {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Nome vendedor']) !!}
                    </div>
                    @if ($errors->has('name'))
        ...
        <div class="btn-group btn-group-full btn-group-space p-t">
            <a href="{{ route('supervisor.sellers.index') }}" class="btn btn-danger">
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group{{ $errors->has('profit_percentage') ? ' has-error' : '' }}">
                    {!! Form::label('profit_percentage', 'Comissão do lucro', ["class" => "control-label"]) !!}
                    <div class="input-group">
            ...
            <div class="col-sm-6">
                <div class="form-group{{ $errors->has('sales_goal') ? ' has-error' : '' }}">
                    {!! Form::label('sales_goal', 'Meta de vendas', ["class" => "control-label"]) !!}
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-dollar"></i></span>
                        {!! Form::number('sales_goal', null, ['class' => 'form-control']) !!}
                    </div>
                </div>
            </div>
        </div>
...
<div class="block full bordered">
    ...
    <div class="block-content form-horizontal form-bordered p-tb p-lr text-light">
        ...
        <div class="form-group{{ $errors->has('percentual_premio') ? ' has-error' : '' }}">
            {!! Form::label('percentual_premio', 'Percentual do prêmio', ['class' => 'col-md-3 control-label']) !!}
            <div class="col-md-2">
                <div class="input-group">
                    {!! Form::number('percentual_premio', null, ['class' => 'form-control', 'min' => 0, 'max' => 100, 'step' => 1]) !!}
                    <span class="input-group-addon"><i class="fa fa-percent"></i></span>
                </div>
            </div>
        </div>
