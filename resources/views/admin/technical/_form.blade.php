<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
    {!! Form::label('name', 'Nome do técnico', ["class" => "col-md-3 control-label"]) !!}
    <div class="col-md-5">
...
<div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
    {!! Form::label('username', 'Nome de usuário', ["class" => "col-md-3 control-label"]) !!}
    <div class="col-md-5">
...
<div class="btn-group btn-group-full btn-group-space p-lr p-tb">
    <a href="{{ route('admin.technical.index') }}" class="btn btn-danger">
