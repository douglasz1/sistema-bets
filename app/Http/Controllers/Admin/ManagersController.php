...
class ManagersController extends Controller
{
    ...
    public function store(ManagersCreateRequest $request)
    {
        try {
            ...
            return redirect()->route('admin.managers.index')->with('success', 'Gerente cadastrado com sucesso');

        } catch (\Throwable $e) {
            return redirect()->route('admin.managers.index')->with('error', "Erro ao cadastrar. {$e->getMessage()}");
        }
    }
    ...
    public function edit($id)
    {
        try {
            ...
            return redirect()->route('admin.managers.index')->with('error', "Erro ao editar. {$e->getMessage()}");
        }
    }
    ...
    public function update(ManagersUpdateRequest $request, $id)
    {
        try {
            ...
            return redirect()->route('admin.managers.index')->with('success', 'Gerente atualizado com sucesso');

        } catch (\Throwable $e) {
            return redirect()->route('admin.managers.index')->with('error', "Erro ao atualizar. {$e->getMessage()}");
        }
    }
    ...
    public function changeStatus($id)
    {
        try {
            ...
            return redirect()->route('admin.managers.index')->with('success', $msg);
        } catch (\Throwable $e) {
            return redirect()->route('admin.managers.index')->with('error', "Erro ao atualizar gerente. {$e->getMessage()}");
        }
    }
