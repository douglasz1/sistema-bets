...
class SellersController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.sellers.create', compact('managers', 'seller'));
    }
    ...
    public function store(SellersCreateRequest $request)
    {
        try {
            ...
            return redirect()->route('admin.sellers.index')->with('success', 'Cambista cadastrado com sucesso');

        } catch (\Throwable $e) {
            return redirect()->route('admin.sellers.index')->with('error', "Erro ao cadastrar. {$e->getMessage()}");
        }
    }
    ...
    public function edit($id)
    {
        try {
            ...
            return view('admin.sellers.edit', compact('seller', 'managers'));

        } catch (\Throwable $e) {
            return redirect()->route('admin.sellers.index')->with('error', "Erro ao editar. {$e->getMessage()}");
        }
    }
    ...
    public function update(SellersUpdateRequest $request, $id)
    {
        try {
            ...
            return redirect()->route('admin.sellers.index')->with('success', 'Cambista atualizado com sucesso');

        } catch (\Throwable $e) {
            return redirect()->route('admin.sellers.index')->with('error', "Erro ao atualizar. {$e->getMessage()}");
        }
    }
    ...
    public function changeStatus($id)
    {
        try {
            ...
            return redirect()->route('admin.sellers.index')->with('success', $msg);
    ...
    public function delete($id)
    {
        try {
            ...
            return response()->json([
                'message' => 'Cambista removido com sucesso',
            ]);

        } catch (\Throwable $e) {
            return response()->json([
                'message' => 'Erro ao apagar vendedor',
                'error' => $e->getMessage()
            ], 400);
        }
    }
